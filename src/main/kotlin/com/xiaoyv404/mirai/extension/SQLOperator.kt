...
data class JsonFindOrNotExpression<T : Any>(
    val left: AsJsonExpression,
    val right: ArgumentExpression<T>,
...
fun AsJsonExpression.findOrNot(param: String): JsonFindOrNotExpression<String> {
    return JsonFindOrNotExpression(this, ArgumentExpression(param, VarcharSqlType))
}